...
export default function S07_Mercado() {
  return (
    <SlideLayout section="06" label="Estudio de Mercado" accent="green">
      <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="flex flex-col h-full gap-5">
        ...
        <motion.div variants={fadeUp} className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] tracking-[0.18em] uppercase font-bold text-green-600/60 mb-1">Encuesta a 33 personas</p>
              <h2 className="text-2xl font-black text-slate-900">Resultados del <span className="gradient-text-green">Estudio de Mercado</span></h2>
            </div>
          </div>
